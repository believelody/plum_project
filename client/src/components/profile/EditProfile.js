...
import { setProfile, getCurrentProfile } from '../../store/actions/profileAction';
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form noValidate onSubmit={this.handleSubmit} className="row">
                <SelectFieldGroup
                  name="status"
                  options={options}
                  value={status}
...
export default connect(mapStateToProps, { setProfile, getCurrentProfile })(withRouter(EditProfile));
